...
@implementation AppDelegate { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, "BluetoothCrashTest.AppDelegate, BluetoothCrashTest", "get_Window");
	}

	-(void) setWindow:(UIWindow *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UIWindow, Xamarin.iOS", "BluetoothCrashTest.AppDelegate, BluetoothCrashTest", "set_Window");
	}

	-(BOOL) application:(UIApplication *)p0 didFinishLaunchingWithOptions:(NSDictionary *)p1
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_5 (self, _cmd, &managed_method, p0, p1, "UIKit.UIApplication, Xamarin.iOS", "Foundation.NSDictionary, Xamarin.iOS", "BluetoothCrashTest.AppDelegate, BluetoothCrashTest", "FinishedLaunching");
	}

	-(void) applicationWillResignActive:(UIApplication *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "BluetoothCrashTest.AppDelegate, BluetoothCrashTest", "OnResignActivation");
	}

	-(void) applicationDidEnterBackground:(UIApplication *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "BluetoothCrashTest.AppDelegate, BluetoothCrashTest", "DidEnterBackground");
	}

	-(void) applicationWillEnterForeground:(UIApplication *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "BluetoothCrashTest.AppDelegate, BluetoothCrashTest", "WillEnterForeground");
	}

	-(void) applicationDidBecomeActive:(UIApplication *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "BluetoothCrashTest.AppDelegate, BluetoothCrashTest", "OnActivated");
	}

	-(void) applicationWillTerminate:(UIApplication *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "BluetoothCrashTest.AppDelegate, BluetoothCrashTest", "WillTerminate");
	}
	...
	-(id) init
	{
		...
		id rv = native_to_managed_trampoline_7 (self, _cmd, &managed_method, "BluetoothCrashTest.AppDelegate, BluetoothCrashTest", ".ctor", &call_super);
		if (call_super && rv) {
...
@implementation ViewController { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "BluetoothCrashTest.ViewController, BluetoothCrashTest", "ViewDidLoad");
	}

	-(void) didReceiveMemoryWarning
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "BluetoothCrashTest.ViewController, BluetoothCrashTest", "DidReceiveMemoryWarning");
	}

	-(void) viewDidAppear:(BOOL)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_8 (self, _cmd, &managed_method, p0, "System.Boolean, mscorlib", "BluetoothCrashTest.ViewController, BluetoothCrashTest", "ViewDidAppear");
	}
...
@end
	...
	static MTClassMap __xamarin_class_map [] = {
		...
		{"EAAccessoryManager", "ExternalAccessory.EAAccessoryManager, Xamarin.iOS", NULL },
		...
		{"AppDelegate", "BluetoothCrashTest.AppDelegate, BluetoothCrashTest", NULL },
		{"ViewController", "BluetoothCrashTest.ViewController, BluetoothCrashTest", NULL },
...
void xamarin_create_classes () {
	...
	__xamarin_class_map [6].handle = objc_getClass ("NSPredicate");
	...
	__xamarin_class_map [15].handle = objc_getClass ("UITraitCollection");
	...
	__xamarin_class_map [23].handle = objc_getClass ("EAAccessoryManager");
	...
	__xamarin_class_map [30].handle = objc_getClass ("NSData");
	__xamarin_class_map [31].handle = objc_getClass ("NSDictionary");
	__xamarin_class_map [32].handle = [AppDelegate class];
	__xamarin_class_map [33].handle = [ViewController class];
